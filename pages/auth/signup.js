            ...
            <div>
                <div className='w-1/3 flex mx-auto justify-center flex-col mt-5'>
                    ...
                    <div>
                        ...
                        <div>
                            <button className='bg-blue-500 w-full text-white py-3 rounded-md text-lg font-bold'>Register</button>
                        </div>
                        <div className='py-4'>
                            <p className=' font-semibold'>You have an account ? <span onClick={() => router.push('/auth/signin')} className='text-blue-600 cursor-pointer'>Login Now</span></p>
                        </div>
                    </div>
                </div>
            </div>
