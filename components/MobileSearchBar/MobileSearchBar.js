...
const MobileSearchBar = () => {
    ...
    return (
        <div style={{ zIndex: '99999', background: 'linear-gradient(45deg, blue, #c72d90)' }} className={` md:hidden block fixed inset-x-0 top-0 z-10 bg-white shadow`}>
            <div className=''>
                <div style={{ width: '95%' }} className=' flex items-center justify-between  relative bg-white mx-auto my-3'>
